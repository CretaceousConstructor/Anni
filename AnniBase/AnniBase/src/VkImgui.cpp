...
//{
//
//	VkImgui::VkImgui(GraphicsComponent& gfx) :
...
//
//		//const auto queue_families_props = DeviceManager::FindQueueFamilies(device_manager.GetPhysicalDevice(), window.GetSurface());
//
...
//		//init_info.QueueFamily = queue_families_props.graphics_family.value();
...
//		//{
//		//	const DeviceManager::QueueFamilyIndices queueFamilyIndices = DeviceManager::FindQueueFamilies(device_manager.GetPhysicalDevice(), window.GetSurface());
//
