...
//namespace Anni
//{
//constexpr uint32_t PbrMetallicMat::GetRequiredDescirpotrCount() const
//{
//	return 4;
//}
//PbrMetallicMat::PbrMetallicMat(GraphicsComponent &gfx_) :
//    Material(gfx_)
//{
//}
//
//VkDescriptorSet PbrMetallicMat::AllocateDescriptorSetAndUpdate(VkDescriptorPool descriptor_pool, VkDescriptorSetLayout desc_set_layout, const std::vector<Gltf::Texture> &textures, const std::vector<std::shared_ptr<VkTexture>> &images, Vk::ModelLoadingOption option)
//{
...
//		const auto ao_image_index                 = textures[occlusionTextureIndex].image_idx;
//		const auto metallic_roughness_image_index = textures[metallicRoughnessTextureIndex].image_idx;
//		/*
...
//void PbrMetallicMat::ModifyPipelineCI(GFXPipelineCI &pipeline_CI)
//{
...
//
//
//void PbrMetallicMat::Register(GraphicsComponent &gfx_)
//{
...
//}
//
//void PbrMetallicMat::UnRegister(GraphicsComponent &gfx_)
//{
...
//}
//
//VkDescriptorSetLayout PbrMetallicMat::GetDescriptorSetLayout()
//{
//	return desc_layout;
//}
//
//VkDescriptorSetLayout PbrMetallicMat::GetDescriptorSetLayoutBindlessRendering()
//{
