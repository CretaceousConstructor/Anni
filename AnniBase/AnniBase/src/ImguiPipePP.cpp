...
//
////ImguiPipePP::ImguiPipePP(GraphicsComponent &gfx_) :
////    GFXPipelineCI(gfx_)
////{
////}
//namespace Anni
//{
//
//	void ImguiPipePPFactory::ConstructInputAssemblyStateCI(GFXPipelineCI& pp)
//	{
//		pp.input_assembly_state_CI = Vk::GetInputAssemblyStateCI(VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, 0, VK_FALSE);
//	}
//
//	void ImguiPipePPFactory::ConstructRasterizationStateCI(GFXPipelineCI& pp)
//	{
...
//	}
//
//	void ImguiPipePPFactory::ConstructDepthStencilStateCI(GFXPipelineCI& pp)
//	{
...
//	}
//
//	void ImguiPipePPFactory::ConstructMultisampleStateCI(GFXPipelineCI& pp)
//	{
...
//	}
//
//	void ImguiPipePPFactory::ConstructDynamicState(GFXPipelineCI& pp)
//	{
...
//	}
//
//	void ImguiPipePPFactory::ConstructColorBlendStateCI(GFXPipelineCI& pp)
//	{
...
//	}
//
//	void ImguiPipePPFactory::ConstructViewPortStateCI(GFXPipelineCI& pp)
//	{
...
//	}
//
//	void ImguiPipePPFactory::ConstructVertexInputStateCI(GFXPipelineCI& pp)
//	{
//	}
//
//	void ImguiPipePPFactory::ConstructRenderingCI(GFXPipelineCI& pp)
//	{
//		pp.pipeline_rendering_CI.pNext = nullptr;
//	}
//
//	ImguiPipePPFactory::ImguiPipePPFactory(GraphicsComponent& gfx_) :
