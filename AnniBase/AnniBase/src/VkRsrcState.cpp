...
//	}
//
//	void RenderGraphV0::StateChangeNoNeedCmdRecording(VkRenderpassManager& renderpass_manager, VirtualResource<Buffer>& vrsc, VkBufUsageInfoRG&)
//	{
//		//TODO:
//	}
//
...
//	}
//
//	void RenderGraphV0::SamplerAndViewChange(VkRenderpassManager& renderpass_manager, VirtualResource<VkTexture>& vrsc, VkRsrcUsageInfoRGUniversalTex& tex_usage)
//	{
//		const auto img_view_CI = tex_usage.tex_usage->GetImgViewCI();
//		const auto sampler_CI = tex_usage.tex_usage->GetSamplerCI();
//
//		if (img_view_CI)
//		{
//			renderpass_manager.GetTextureFactory().ResetTexImgView(*img_view_CI, *vrsc.ptr_rsrc);
...
//	}
//
//	void RenderGraphV0::SamplerAndViewChange(VkRenderpassManager& renderpass_manager, VirtualResource<Buffer>& vrsc, VkBufUsageInfoRG& buf_usage)
//	{
//
//		//TODO: storage buffer, buffer view change
//
//	}
//
//
