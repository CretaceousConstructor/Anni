...
//namespace Anni
//{
//	constexpr uint32_t NonPbrMat::GetRequiredDescirpotrCount() const
//	{
//		return 2;
//	}
//
//	NonPbrMat::NonPbrMat(GraphicsComponent& gfx_) :
//		Material(gfx_)
//	{
//	}
//
//
//
//	VkDescriptorSet NonPbrMat::AllocateDescriptorSetAndUpdate(VkDescriptorPool descriptor_pool, VkDescriptorSetLayout desc_set_layout, const std::vector<Gltf::Texture>& textures, const std::vector<std::shared_ptr<VkTexture>>& images, Vk::ModelLoadingOption option)
//	{
...
//				const auto color_image_index = textures[baseColorTextureIndex].image_idx;
//			const auto normal_image_index = textures[normalTextureIndex].image_idx;
//			/*
...
//			VK_CHECK_RESULT(vkAllocateDescriptorSets(device_manager.GetLogicalDevice(), &allocInfoWrite, &temp_descriptor_set))
//				//UPDATE DESCRIPTORS INFO
//				const auto albedo_image_index = textures[baseColorTextureIndex].image_idx;
//			const auto normal_image_index = textures[normalTextureIndex].image_idx;
//
//			/*
...
//	}
//
//	void NonPbrMat::ModifyPipelineCI(GFXPipelineCI& pipeline_CI)
//	{
//		//assert(1 == 2);
...
//
//		const GFXPipelineCI::VkSpecializationInfoPack result{ .sp_info = specialization_info, .shader_stage = VK_SHADER_STAGE_FRAGMENT_BIT };
//
...
//	}
//
//	VkDescriptorSetLayout NonPbrMat::GetDescriptorSetLayout()
//	{
//		return desc_layout;
//	}
//
//	VkDescriptorSetLayout NonPbrMat::GetDescriptorSetLayoutBindlessRendering()
//	{
//		return desc_layout_bindless_rendering;
//	}
//
//	//VkDescriptorSetLayout NonPbrMat::CreateDesciptorSetLayout(const DeviceManager &device_manager)
//	//{
...
//	//}
//
//	VkPipelineLayout NonPbrMat::CreatePipelineLayout(const DeviceManager& device_manager, const std::vector<VkDescriptorSetLayout>& set_layouts, const std::vector<VkPushConstantRange>& push_constant_ranges)
//	{
//		return Vk::GetPipelineLayout(device_manager.GetLogicalDevice(), set_layouts, push_constant_ranges);
//	}
//
//	void NonPbrMat::Register(GraphicsComponent& gfx_)
//	{
...
//	}
//
//	void NonPbrMat::UnRegister(GraphicsComponent& gfx)
//	{
