...
//{
//	const auto info_t = rsrc_info->GeRsrcType();
//
...
//			const auto &rsrc_buffer    = dynamic_cast<RenderGraph::Resource<Buffer> &>(*resources[rsrcs_slot.resource_handle]);
//
...
//	////          [&RG](const std::pair<ResourceSlot, RsrcUsageInfoSlot> &lhs, const std::pair<ResourceSlot, RsrcUsageInfoSlot> &rhs) -> bool {
//	////	          const auto &lhs_attch_info = dynamic_cast<Buffer::WithinPassRG &>(*RG.rsrc_usage_infos[lhs.second.handle]);
//	////	          const auto &rhs_attch_info = dynamic_cast<Buffer::WithinPassRG &>(*RG.rsrc_usage_infos[rhs.second.handle]);
//
...
//
//	//	const auto rsrc_uniform_buffer = dynamic_cast<Resource<Buffer> *>(RG.resources[ub_rsrc.first.resource_handle]);
//
