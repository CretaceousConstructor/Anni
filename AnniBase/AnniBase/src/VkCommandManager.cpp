...
//namespace Anni
//{
//	VkCommandManager::VkCommandManager(DeviceManager& _device_manager, size_t num_of_graphics_command_buffers, size_t num_of_transfer_command_buffer) :
//		device_manager(_device_manager)
//		//,
//	 //   graphics_command_pool(device_manager.CreateCommandPool(DeviceManager::CommandPoolType::graphics_command_pool)),
//	 //   transfer_command_pool(device_manager.CreateCommandPool(DeviceManager::CommandPoolType::transfor_command_pool))
//	{
