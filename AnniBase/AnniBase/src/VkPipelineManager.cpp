...
//
//VkPipelineManager::VkPipelineManager(GraphicsComponent &_gfx) :
//    gfx(_gfx),
...
//}
//
//void VkPipelineManager::AddPipeline(const GFXPipelineCI &para_pack, const PipelineMetaInfo pipe_meta_info)
//{
