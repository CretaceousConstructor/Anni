...
namespace Anni
{
	...
	//	//VkModel(const std::string model_path, GraphicsComponent &gfx_);
	//
	//
	//	VkModel(std::vector<V> &para_vertex, std::vector<InsType> &para_instance_data, std::vector<uint32_t> &para_indices, GraphicsComponent &gfx_);
	//	VkModel(std::vector<V> &para_vertex, std::vector<uint32_t> &para_indices, GraphicsComponent &gfx_);
	//
	...
	//		void           CleanUp(const DeviceManager &para_device_manager);
	//	};
	//	struct Indices
	//	{
	//		uint32_t       count{};
	...
	////inline VkModel<V, InsType>::VkModel(const std::string model_path,GraphicsComponent& gfx_) :
	////    gfx(gfx_),
	...
	//
	//template <class V, class InsType>
	//inline VkModel<V, InsType>::VkModel(std::vector<V> &para_vertex, std::vector<uint32_t> &para_indices, GraphicsComponent &gfx_) :
	//    gfx(gfx_),
	//    device_manager(gfx.DeviceMan()),
	//    window(gfx.Window()),
	//    command_manager(gfx.CommandMan())
	...
	//
	//template <class V, class InsType>
	//VkModel<V, InsType>::VkModel(std::vector<V> &para_vertex, std::vector<InsType> &para_instance_data, std::vector<uint32_t> &para_indices, GraphicsComponent &gfx_)
	//
	//    :
	//    gfx(gfx_),
	//    device_manager(gfx.DeviceMan()),
	...
	//
	//template <class V, class InsType>
	//void VkModel<V, InsType>::Vertices::CleanUp(const DeviceManager &para_device_manager)
	//{
	//	if (buffer)
	//	{
	...
	//
	//template <class V, class InsType>
	//void VkModel<V, InsType>::Indices::CleanUp(const DeviceManager &para_device_manager)
	//{
	//	if (buffer)
	//	{
	//		vkDestroyBuffer(para_device_manager.GetLogicalDevice(), buffer, nullptr);
	...
	//
	//template <class V, class InsType>
	//void VkModel<V, InsType>::InstancesData::CleanUp(const DeviceManager &para_device_manager)
	//{
	//	if (buffer)
	//	{
	//		vkDestroyBuffer(para_device_manager.GetLogicalDevice(), buffer, nullptr);
